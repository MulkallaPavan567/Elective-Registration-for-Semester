                ...
                <div class="panel panel-default">
                    ...
                    while($row=mysqli_fetch_array($sql)) { ?>
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    for($i=0;$i<$optional_core_count;$i++) {
                                        ...
                                        <select class="form-control" name="optional_cores[]" id="optional_cores_<?php echo $i; ?>" required="required">
                                            ...
                                            ?>
                                            <option value="<?php echo htmlentities($rows2['courseName']);?>" <?php if($selected_values == $rows2['courseName']) { echo 'disabled'; } ?>><?php echo htmlentities($rows2['courseName']);?></option>
                                            <?php } ?>
                                        </select>
                                        <br>
                                    <?php } ?>
                            ...
                            <form method='post'>
                                <div>
                                    <button type="submit" name="submit1" id="submit1" class="btn btn-default" <?php if ($optional_core_count <= 0) { echo 'disabled'; } ?>>Proceed for Elective Preference</button>
                                </div>
                            </form>
