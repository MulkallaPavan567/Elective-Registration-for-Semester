...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "SELECT studentRegno, optional_core_choice_1, optional_core_choice_2, optional_core_choice_3, optional_core_choice_4, optional_core_choice_5
                                    FROM students
        ...
        while ($row = mysqli_fetch_array($sql)) {
            ...
            foreach ($choices as $choice) {
                if ($choice != NULL && $choice != "NULL") {
                    ...
                    $sqlInsert = "INSERT INTO courses_allocated (course_code, student_reg_no)
                                    VALUES ('$courseCode', '$studentRegNo')";
