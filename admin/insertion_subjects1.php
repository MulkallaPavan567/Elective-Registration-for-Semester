        ...
        try {
            ...
            if (($handle = fopen($file, "r")) !== false) {
                while (($data = fgetcsv($handle, 1000, ",")) !== false) {
                    ...
                    $courseName = $data[1];
                    $faculty_name = $data[2];
                    $bucket_number = $data[3];
                    $seats_for_MCA = $data[4];
                    $seats_for_IMTECH_3_4 = $data[5];
                    $seats_for_IMTECH_5_6 = $data[6];
                    $seats_for_IMTECH_7_8 = $data[7];
                    $seats_for_MTECH_AI = $data[8];
                    $seats_for_MTECH_CS = $data[9];
                    $seats_for_MTECH_IT = $data[10];
